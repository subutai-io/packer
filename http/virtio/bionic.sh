...
cat > $BASE_DIR/http/virtio/bionic.cfg <<-EOF
# Account setup
...
cat $BASE_DIR/http/virtio/partition.cfg >> $BASE_DIR/http/virtio/bionic.cfg
...
cat $BASE_DIR/http/packages.cfg >> $BASE_DIR/http/virtio/bionic.cfg
