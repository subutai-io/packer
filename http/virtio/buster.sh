...
cat > $BASE_DIR/http/virtio/buster.cfg <<-EOF
# Account setup
...
cat $BASE_DIR/http/virtio/partition.cfg >> http/virtio/buster.cfg
...
cat $BASE_DIR/http/packages.cfg >> $BASE_DIR/http/virtio/buster.cfg
